...
<body>
	...
	<div id="page-container">
		...
		<div align="left">
			<img src="images/bird-top2.jpg" alt="Arizona&rsquo;s last free-flowing rivers" width="344" height="63" border="0" align="bottom" />
		</div>
      ...
      <div class="clear-floats">
    	...
    	<div id="content-left">
      	The Verde River, one of Arizona&rsquo;s last free-flowing rivers, sustains a large regional wildlife
      	...
      	<div id="flash-home">
        	<object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="583" height="276">
          	...
          	<param name="swfversion" value="6.0.65.0" />
        		<!-- This param tag prompts users with Flash Player 6.0 r65 and higher to download the latest version of
						Flash Player. Delete it if you don�t want users to see the prompt. -->
    ...
    <div id="content-right">
      ...
      <div align="center" style="margin-bottom:14pt; margin-top:10pt">
				<img src="images/sidebar-photo.jpg" width="240" height="131" alt=" habitat in the Verde Valley" />
			</div>
