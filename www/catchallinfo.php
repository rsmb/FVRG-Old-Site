...
/**
 * Project:     Catchall: A PHP class for creating and managing form CAPTCHA images<br />
 * File:        catchall.php<br />
 *
 ...
 *
 * @link http://www.phpcaptcha.org Catchall PHP CAPTCHA
 * @link http://www.phpcaptcha.org/latest.zip Download Latest Version
 * @link http://www.phpcaptcha.org/Catchall_Docs/ Online Documentation
...
class Catchall {
   ...
   *
   * @see Catchall::$text_transparency_percentage
   * @var boolean
   */
   ...
   *
   * @see Catchall::$use_transparent_text
   * @var int
   */
   ...
   *
   * @see Catchall::$line_color
   * @see Catchall::$line_distance
   * @see Catchall::$line_thickness
   * @see Catchall::$draw_lines_over_text
   * @var boolean
   */
  var $draw_lines = true;
  ...
  function saveData()
  {
    $_SESSION['catchall_code_value'] = strtolower($this->code);
  }
  ...
  function validate()
  {
    if ( isset($_SESSION['catchall_code_value']) && !empty($_SESSION['catchall_code_value']) ) {
      if ( $_SESSION['catchall_code_value'] == strtolower(trim($this->code_entered)) ) {
        $this->correct_code = true;
        $_SESSION['catchall_code_value'] = '';
      } else {
  ...
  {
    if (isset($_SESSION['catchall_code_value']) && !empty($_SESSION['catchall_code_value'])) {
      return $_SESSION['catchall_code_value'];
    } else {
      return '';
    }
  }
